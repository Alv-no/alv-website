...
import { Title, Description, EmployeeSection, Cta, createSlugForEmployee } from 'shared-components';
...
const Employees : React.FC<Props> = ({ location, serverData }) => {
  ...
  if (location.state) {
    ...
    const card = allEmployees.find((el : any) => {
...
async function getEmployeeData() {
  ...
  employeeData.allEmployeeTag = employeeData.allEmployeeTag.map((tag : any) => ({
    node: tag,
  }));

  employeeData.allEmployee = employeeData.allEmployee.map((employee : any) => {
