...
const About : React.FC<Props> = ({ serverData }) => {
  ...
  const employees = data.allSanityEmployee.edges.map((el : any) => el.node);
  employees.map(
    (el : any) => (el.fallbackImg = data.fallbackImg.childImageSharp.gatsbyImageData)
  );
