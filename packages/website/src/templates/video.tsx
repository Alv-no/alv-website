...
import { SocialShare } from 'shared-components';
...
const Sidebar : React.FC<SidebarProps> = ({ playlist, playlistName }) => (
...
const VideoTemplate : React.FC<VideoTemplate> = ({ pageContext }) => {
