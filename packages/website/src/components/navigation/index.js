...
const ListLink = ({ children, link }) => (
  <li className="text-base uppercase font-light nine:mb-3 2xl:mb-4 tracking-wider">
...
export const Navigation = ({ open, toggleClose }) => {
  return (
    <header
      className={`text-white tracking-wider fixed z-50 h-full w-full bg-navy p-8 top-0 transition duration-300 ${
        open ? 'opacity-100' : 'opacity-0 pointer-events-none'
      }`}
    >
      <div className="flex justify-between mx-auto auto nine:mb-10 2xl:mb-25 max-w-1200 items-center">
        <div className="w-32" />
        <span className="">
          <Link to="/">
            <Logo.White />
      ...
      <div className="flex justify-between max-w-1000 mx-auto">
        <div>
          <LargeLink margin="nine:mb-10 2xl:mb-12">Vi Tilbyr</LargeLink>
          <Subtitle margin="nine:mb-8 2xl:mb-10">Systemutvikling</Subtitle>
          <ul className="">
        ...
        <div className="transform translate-x-5">
          <Subtitle margin="nine:mt-16 2xl:mt-20 nine:pt-3 2xl:pt-1">
            Data &amp; Analyse
          </Subtitle>
          <ul className="nine:mt-8 2xl:mt-10">
        ...
        <div>
          <LargeLink margin="nine:mb-10 2xl:mb-12">Jobbe i Alv</LargeLink>
          <LargeLink margin="nine:mb-10 2xl:mb-12">Selskapet</LargeLink>
          <Subtitle margin="nine:mb-5 2xl:mb-6">Om Oss</Subtitle>
          <Subtitle margin="nine:mb-5 2xl:mb-6">Aktuelt</Subtitle>
          <Subtitle margin="nine:mb-5 2xl:mb-6">
            <Link to="/ansatte">Ansatte</Link>
          </Subtitle>
          <LargeLink margin="nine:mt-10 2xl:mt-12">Videoserie</LargeLink>
          <LargeLink margin="nine:mt-10 2xl:mt-12">Blogg</LargeLink>
          <LargeLink margin="nine:mt-10 2xl:mt-12">
            <Link to="kontakt-oss">Kontakt Oss</Link>
          </LargeLink>
        </div>
      </div>
      <div className="flex justify-center nine:mt-10 2xl:mt-24">
