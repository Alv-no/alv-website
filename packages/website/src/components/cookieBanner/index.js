...
const CookieBanner = () => {
  ...
  return (
    <div
      className={`fixed bottom-0 left-0 bg-navy text-white z-[50000000] w-screen border-t-solid border-t-4 p-6 sm:w-2/3 sm:max-w-[400px] sm:left-4 sm:bottom-4 sm:border-solid sm:border-2 sm:rounded-xl ${
    ...
    >
      ...
      <p className="text-center font-light mt-4 text-sm">
        Vi bruker informasjonskapsler for å gi deg en best mulig opplevelse av
        alv.no, du kan lese mer om det i{" "}
        <a
          className="underline"
