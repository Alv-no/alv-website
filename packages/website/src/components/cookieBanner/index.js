...
const CookieBanner = () => {
  ...
  return (
    <>
      {showBanner && (
        <div className="fixed bottom-0 left-0 bg-navy text-white z-[50000000] w-screen border-t-solid border-t-4 p-6 sm:w-2/3 sm:max-w-[400px] sm:left-4 sm:bottom-4 sm:border-solid sm:border-2 sm:rounded-xl">
