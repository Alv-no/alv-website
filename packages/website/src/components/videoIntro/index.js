...
export const VideoIntro = ({ videoMp4, videoWebm, children }) => {
  return (
    ...
    >
      ...
      <Fade>
        <h2 className="mx-5 sm:mx-16 uppercase block lg:hidden text-index sm:text-slider font-semibold tracking-wider text-white sm:w-7/12 leading-tight mt-5 sm:mt-10">
          {children}
        </h2>
      </Fade>
    </div>
