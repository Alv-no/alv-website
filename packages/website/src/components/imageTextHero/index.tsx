...
interface ImageTextListHeroProps {
  image: any;
  positionsListLeft: any[];
  positionsListRight: any[];
}

export const ImageTextListHero : React.FC<ImageTextListHeroProps> = ({
  image,
  positionsListRight,
  positionsListLeft,
}) => {
...
export const Roles : React.FC<RolesProps> = ({ children, link }) => (
  <Link to={link}>
    <div
...
export const Mail : React.FC<MailProps> = ({ children, link }) => (
