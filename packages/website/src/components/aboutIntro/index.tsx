...
import { Title, Description, Icon } from 'shared-components';
const { Arrow } = Icon;

type Image = any; // TODO: find proper type here
...
const AboutIntro : React.FC<AboutIntroProps> = ({ topImg, topImgAlt, bottomImg, bottomImgAlt }) => {
  return (
    <div
...
const ReadMoreLink : React.FC<ReadMoreLinkProps> = ({ link, children }) => (
  <Link
    to={link}
